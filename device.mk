...
# Get GMS
GAPPS_VARIANT ?= pico
$(if $(filter user,$(TARGET_BUILD_VARIANT)),,$(call inherit-product-if-exists,$(if $(wildcard vendor/google/products/gms.mk),vendor/google/products/gms.mk,vendor/opengapps/build/opengapps-packages.mk)))
